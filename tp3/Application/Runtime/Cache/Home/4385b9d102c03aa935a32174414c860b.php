...
<head>
    ...
    <title>微留言演示案例</title>
    <link rel="stylesheet" type="text/css" href="/tp3/public/message./msg.css" media="all" />	
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
	  	<div class="qiandaobanner">
		  	<a href="/tp3/public/message">
		  		<img src="/tp3/public/message/wall.jpg" style="width:100%;" />
		  	</a>
	  	</div>
  			...
  			<div class="history">
				<div class="history-date">
					<ul>
						...
						<?php if(is_array($msgs)): $i = 0; $__LIST__ = $msgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i;?><li class="green bounceInDown">
							<h3>
								<img src="/tp3/public/message/logo100x100.jpg"> 
								<?php echo ($msg["uname"]); ?>
								<span><?php echo date('Y-m-d', $msg['created_at']); ?></span>
								<div class="clr"></div>
							</h3>
							<dl>
	...
	<script type="text/javascript" src="/tp3/public/message/jquery.js"></script>
